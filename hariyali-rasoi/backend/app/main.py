...
from app.startup import seed_menu_if_empty, sync_store_contact_from_env, ensure_store_hours
...
# LAN + free-host previews (*.onrender.com). Custom domains go in CORS_ORIGINS.
_CORS_ORIGIN_REGEX = (
    r"https?://("
